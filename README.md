...
# NestJS + Keycloak Integration Example

A functional API example demonstrating:

- **Role-based access control** (RBAC) using Keycloak  
- **Automatic JWT validation** via `nest-keycloak-connect`  
- **Protected endpoints** with different permission levels  

## Key Features
✅ Secure authentication flow (Keycloak)  
...
3. API validates tokens and checks roles automatically  
